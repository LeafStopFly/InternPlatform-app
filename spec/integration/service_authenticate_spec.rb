...
describe 'Test Service Objects' do
  ...
  describe 'Find authenticated account' do
    it 'HAPPY: should find an authenticated account' do
      ...
      account = ISSInternship::AuthenticateAccount.new(app.config).call(**@credentials)
    ...
    it 'BAD: should not find a false authenticated account' do
      ...
      _(proc {
        ISSInternship::AuthenticateAccount.new(app.config).call(**@mal_credentials)
      }).must_raise ISSInternship::AuthenticateAccount::UnauthorizedError
    end
  end
end
